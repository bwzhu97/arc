...
solvers_and_options = {struct('solver', @trustregions, 'name', 'RTR'), ...
                       struct('solver', @arc, 'theta', .25, 'name', 'ARC-L'), ...
                       struct('solver', @arc, 'theta', .25, 'subproblemsolver', @arc_conjugate_gradient, 'name', 'ARC-CG'), ...
                 ... % struct('solver', @arc, 'theta', .5, 'subproblemsolver', @arc_gradient_descent, 'maxiter', 100, 'name', 'ARC-GD'), ...
                 ... % struct('solver', @arc, 'theta', .25, 'subproblemsolver', @arc_conjugate_gradient, 'beta_type', 'F-R', 'name', 'ARC-CG-FR'), ...
                       };
